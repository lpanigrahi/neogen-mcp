...
> Transform your chatbot experience with powerful system prompt customization. The neogen-mcp uses a sophisticated multi-layered prompt system that adapts to your preferences, project context, and MCP tool usage — making every conversation more personalized and effective.
...
1. **Base System Prompt** - Core neogen-mcp behavior
