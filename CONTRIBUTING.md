# Contributing to neogen-mcp

Thank you for your interest in contributing to neogen-mcp! We welcome contributions from the community and truly appreciate your effort to improve the project.
...
2. **Clone your fork** locally:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/neogen-mcp.git
   cd neogen-mcp
   ```
...
We sincerely appreciate your contribution to neogen-mcp.
